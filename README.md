...
> 🍵 前端修炼者 · 喜欢把复杂的问题拆得干净利落 | 图形渲染与性能优化爱好者 | 茉莉花茶常备 | 欢迎来逛逛 ⭐

![访问计数](https://komarev.com/ghpvc/?username=lenkaset&style=flat-square&color=7c7cf0)
...
loves:
  ...
  - Rust/WASM 的性能快感 ⚡
  - 一壶茉莉花茶 🍵
learning: Rust · WebGPU · AI 图像生成
superpower: 把复杂的问题拆得干净利落 🧩
```

- ⚡ 专注前端工程化与图形渲染，喜欢把性能榨到最后一帧
- 🍵 写代码标配一壶茉莉花茶，思路不清晰就先续一杯
- 🧩 信奉「好代码是拆出来的」——问题再大，拆成小块就看得清了
- ⭐ 如果这里有什么帮到你，点个 star 就是最好的认可

---

## 🛠️ 技术栈

![前端](https://skillicons.dev/icons?i=react,ts,js,html,css,tailwind,vite,nodejs,pnpm,git&perline=10&theme=dark)
...
[![GitHub stats](https://github-readme-stats.vercel.app/api?username=lenkaset&show_icons=true&theme=nightowl&hide_border=true&bg_color=0,16161e,2b2a4a&title_color=ffffff&text_color=c9cbe8&icon_color=f4a261)](https://github.com/anuraghazra/github-readme-stats)
...
- ⚡ **image-processor** — Rust WASM 图像处理引擎
- 🎨 **xagent-studio** — AI 图像生成应用
- 🐙 [**OpenMAIC**](https://github.com/lenkaset/OpenMAIC) / [**GoFilm**](https://github.com/lenkaset/GoFilm) — 最近在学习的项目
...
- 📮 Email：`lenkaset@qq.com`
- 📝 博客：`https://www.cnblogs.com/lenkaset`
- 🐙 [GitHub](https://github.com/lenkaset)

*⭐ 觉得有用就点个 star，让我多续一壶茉莉花茶 🍵*
